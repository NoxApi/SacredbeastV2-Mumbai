...
export class SCBV2__lockChoicesResult {
  value0: BigInt;
  value1: BigInt;
...
export class SCBV2__rewardDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class SCBV2 extends ethereum.SmartContract {
  static bind(address: Address): SCBV2 {
    return new SCBV2("SCBV2", address);
  }
  ...
  lockChoices(param0: BigInt): SCBV2__lockChoicesResult {
    let result = super.call(
      "lockChoices",
    ...
    return new SCBV2__lockChoicesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_lockChoices(
    param0: BigInt
  ): ethereum.CallResult<SCBV2__lockChoicesResult> {
    let result = super.tryCall(
      "lockChoices",
      "lockChoices(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new SCBV2__lockChoicesResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  nft(param0: BigInt): SCBV2__nftResult {
    let result = super.call("nft", "nft(uint256):(uint8,uint8,uint256)", [
      ethereum.Value.fromUnsignedBigInt(param0)
    ]);

    return new SCBV2__nftResult(
      result[0].toI32(),
      result[1].toI32(),
      result[2].toBigInt()
    );
  ...
  try_nft(param0: BigInt): ethereum.CallResult<SCBV2__nftResult> {
  ...
  rewardData(param0: Address): SCBV2__rewardDataResult {
    let result = super.call(
      "rewardData",
    ...
    return new SCBV2__rewardDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_rewardData(
    param0: Address
  ): ethereum.CallResult<SCBV2__rewardDataResult> {
    let result = super.tryCall(
      "rewardData",
      "rewardData(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
